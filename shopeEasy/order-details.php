            ...
            <div class="card shadow mt-4">
                <div class="card-body">
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <?php if ($item['image_url']): ?>
                                                    <img src="<?php echo $item['image_url']; ?>" alt="<?php echo $item['name']; ?>" class="img-thumbnail me-2" style="width: 50px;">
                                                <?php endif; ?>
                    ...
                    <div class="d-grid gap-2 mt-4">
                        <a href="profile.php" class="btn btn-outline-secondary">Back to Orders</a>
